...
Full conversation logs and raw experimental runs are excluded from the public repository due to security and confidentiality considerations but are retained by the author and available for academic review upon request